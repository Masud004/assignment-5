document.getElementById("history-btn").addEventListener("click", function () {
    const historyBtn = document.getElementById("history-btn").classList.add("bg-[#b4f461]");
    const donateBtn = document.getElementById("donation-btn").classList.remove("bg-[#b4f461]");
